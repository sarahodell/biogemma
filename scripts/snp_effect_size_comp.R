...
#Using most significant 600K SNP as focal SNP
...
f_ses=readRDS('GridLMM/effect_sizes/600K_SNP_peak_Founder_ES.rds')
h_ses=readRDS('GridLMM/effect_sizes/600K_SNP_peak_Haplotype_ES.rds')
...
saveRDS(plots,'GridLMM/effect_sizes/All_effect_sizes_600K_SNP.rds')
