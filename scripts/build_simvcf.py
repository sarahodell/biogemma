...
def main():
    ...
    header,stderr=bcftools_view(donorfile='biogemma/Biogemma_600K_Genotypes.vcf.gz',header=True)
    print(stderr)
    for sample in samples:
        ...
        for i in parents:
            ...
            positions,stderr=bcftools_view(donorfile='biogemma/founders/{0}_600K_Genotypes.vcf.gz'.format(i),regionsfile=regionsfile)
            print(stderr)
	    vcf+=positions
