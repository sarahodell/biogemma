...
for(i in 1:10){
   ...
   mod=readRDS(sprintf('models/chr%.0f_%s_x_%s_600KSNP_ML.rds',i,pheno,env))
...
png(sprintf('images/%s_x_%s_manhattan_600K_ML_sig.png',pheno,env),width=960,height=680)
