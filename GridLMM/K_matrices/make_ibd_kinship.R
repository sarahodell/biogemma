...
X_list=readRDS(sprintf('../../haplotype_probs/bg%s_filtered_haplogroup%s_probs.rds',c,h))
...
fwrite(shared,sprintf('chr%s_hapgrp%s_ibd_K_matrix.txt',c,h),quote=F,row.names=F,col.names=T)
