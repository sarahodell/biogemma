...
for(i in 1:10){
   ...
   mod=readRDS(sprintf('models/Biogemma_chr%.0f_%s_x_%s_founderprobs_MITE_only.rds',i,pheno,env))
...
png(sprintf('images/%s_x_%s_MITE_only_manhattan.png',pheno,env),width=960,height=680)
