...
This csv file is formatted for use with R/qtl2""")
    ...
    parser.add_argument("--region",type=str,help="""Specific region in vcf to grab. Can be of format Chr or Chr:from-to""",default=None)
    args=parser.parse_args()
    return args


def call_bcftools(infile,region):
...
def get_genofile():
    args=parse_args()
    samples,info = call_bcftools(args.infile,args.region)
    txt='ind'
    geno={}
